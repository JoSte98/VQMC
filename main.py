...
def main():
    ...
    #### initialize the model
    model_LHO = VQMC(model='LHO', init_alpha=0.175, max_step_length=2.0, num_walkers=400, Focker_Planck=True)
    ...
    ##### HYDROGEN ATOM
    #### initialize the model
    model_H = VQMC(model='Hydrogen', init_alpha=0.8, max_step_length=0.6, Focker_Planck=True)
